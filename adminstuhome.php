...
<body>
    <div class="header">
        <div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed">
            ...
            <ul class="pure-menu-list">
                <li class="pure-menu-item pure-menu"><a href="adminstuhome.php" class="pure-menu-link">Home</a></li>
                <li class="pure-menu-item"><a href="adminhome.php" class="pure-menu-link">Admin Page</a></li>
    ...
    <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
        ...
        <?php
                echo "<table class='pure-table pure-table'><thead><tr><th>Course Name</td><td><b>Primary Topic</th><th><b>Secondary Topics</td></th><thead><tbody>";
    ...
    <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
        <h3>To enroll in more courses, click</h3> 
        <a href="enroll.php" class="pure-button">here.</a>
...
<div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
    ...
    <?php
            ...
            echo "<table class='pure-table'><tr><thead><th>Course Name</td><th><b>Primary Topic</td><th>Secondary Topics</th></tr></thead>";
...
<div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
    <h3 class="content-subhead">To add to your course interests, click <a href="interest.php" class="pure-button pure-button-primary">here.</a></h3>
</div>
...
<div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
    ...
    echo "<table class='pure-table'><tr><td><b>Course Name</td><td><b>Completion Date</td></tr>";
  ...
  <div class="l-box pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
      <?php
        ...
        echo "<table class='pure-table'><tr><td><b>Course Name</td><td><b>Primary Topic</td><td><b>Secondary Topics</td></tr>";
