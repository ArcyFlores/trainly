    ...
    <div class="header">
        <div class="home-menu pure-menu pure-menu-horizontal pure-menu-fixed">
            ...
            <ul class="pure-menu-list">
                <li class="pure-menu-item pure-menu"><a href="facultystuhome.php" class="pure-menu-link">Home</a></li>
                <li class="pure-menu-item"><a href="homefaculty.php" class="pure-menu-link">Faculty Page</a></li>
