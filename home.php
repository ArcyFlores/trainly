        ...
        <div class="content top-buffer-xl">
            ...
            <div class="pure-g">
                ...
                <div class="l-box-lg pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
                    ...
                    <h3>To enroll in more courses, click
                ...
                <div class="l-box-lg pure-u-1 pure-u-md-1-2 pure-u-lg-1-4">
                    ...
                    <h3 class="content-subhead">To add to your course interests, click 
                        <a href="interest.php" class="pure-button">here.</a>
                    </h3>
                </div>
